...
"""
stimulus_strength[0] = stimulus_strength[0]/1050
stimulus_strength[1] = stimulus_strength[1]/1050
...
for k in range(101):
    ...
    s_in_1 = d_in * inhibition_t1_2
    s_out_1 = d_out * inhibition_t1_2
   
    # dependent on inhibition_t1_1
    s_in_2 = d_in * inhibition_t1_1
    s_out_2 = d_out * inhibition_t1_1
...
"""
TODO: update according to cropping
"""
...
if OT_t1_1 > OT_t1_2: # stimulus on the left is bigger
    left_stimulus_location = [middle_x/2, middle_y/2]
    opposite = abs(left_stimulus_location[0] - middle_x)
    adjacent = abs(left_stimulus_location[1] - middle_y)

    theta = np.rad2deg(np.arctan(opposite/adjacent))
    ...
    right_stimulus_location = [middle_x * 1.5, middle_y/2]
       
    opposite = abs(right_stimulus_location[0] - middle_x)
    adjacent = abs(right_stimulus_location[1] - middle_y)
